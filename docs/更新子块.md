...
````yaml zh-hans/openapi_knowledge.json patch /datasets/{dataset_id}/documents/{document_id}/segments/{segment_id}/child_chunks/{child_chunk_id}
paths:
  path: >-
              ...
              content:
                allOf:
                  - type: string
                    description: 子块的更新内容。
            required: true
            refIdentifier: '#/components/schemas/UpdateChildChunkRequest'
            requiredProperties:
              - content
        examples:
          example:
